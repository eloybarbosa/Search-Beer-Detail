    ...
    <h2>SEARCH BEER</h2>
      ...
      <b-row align-v="center">
        <b-col cols=6 sm class="detail">
                  <b-img src="https://cms.rockymountain.com.br/runners/wp-content/uploads/sites/4/2018/10/cerveja-e-corrida.jpg" fluid alt="Foto Copo de Cerveja" 
                  style="min-width: 300px;;max-width: 450px"></b-img>
        </b-col>
        <b-col cols=6 sm class="detail">
            <b-card :title=cerveja.name :sub-title=cerveja.rewery_type>
                <b-card-text>
                    id:  {{ $route.params.id}}
                </b-card-text>

                <b-card-text>Nome da Cervejaria : {{ cerveja.name}}</b-card-text>
                <b-card-text>Tipo de Cerveja : {{ cerveja.rewery_type}}</b-card-text>
                <b-card-text>Endereço : {{ cerveja.street }} {{ cerveja.city }} {{ cerveja.state }} {{ cerveja.country }}</b-card-text>
                <b-card-text>Telefone Cervejaria : {{ cerveja.phone}}</b-card-text>
...
export default {
  ...
  data: function(){
    ...
    computed:{
        cerveja: function(){
            let cerveja = this.cervejarias(elem => elem.id == this.$route.params.id)
            return cerveja[0]
        }
    },
}
