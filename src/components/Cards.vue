<template>
  <div>
    ...
    <b-container fluid class="bv-example-row" >
        <b-row cols="3" offset-md="2">
          <div class="card mb-3"
            :key="cerveja.id" v-for="cerveja in cervejarias"
            style="max-width: 540px;">
            <div class="row no-gutters">
              <div class="col-md-4">
                <img
                  src="https://cms.rockymountain.com.br/runners/wp-content/uploads/sites/4/2018/10/cerveja-e-corrida.jpg"
                  class="card-img"
                  alt="..."
                />
              </div>
              <div class="col-md-8">
                <div class="card-body">
                  ...
                  <b-card-text><router-link tag="h5" class="card-title" 
                  :to="{ name: 'detalCards', params: { id: cerveja.id }} " >
                  {{ cerveja.brewery_type }}</router-link></b-card-text>

                  <div>{{cerveja.city}}</div>
                  <div>{{cerveja.updated_at}}</div>
                  <a :href="cerveja.website_url" class="btn btn-warning">Visitar</a>
                </div>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    mostrarBusca() {
      this.mostrarCervejarias = this.mostrarCervejarias ? false : true;
    }
  }
};
</script>
...
h2 {
  ...
  margin-top: 50px;
  color: rgb(221, 169, 0);
  border-top: solid 5px rgb(221, 169, 0);
  border-bottom: solid 5px rgb(221, 169, 0);
